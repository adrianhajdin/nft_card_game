      ...
      <div className="flex flex-1 justify-between bg-siteblack py-8 sm:px-12 px-8 flex-col">
        ...
        <div className="flex-1 flex justify-center flex-col xl:mt-0 my-16">
          ...
          <div className="flex flex-col">
            ...
            <button type="button" className="mt-6 px-4 py-2 rounded-lg bg-siteViolet w-fit text-white font-rajdhani font-bold" onClick={handleClick}>Create Battle</button>
          </div>
