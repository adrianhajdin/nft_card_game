    ...
    <div className="flex flex-1 justify-between bg-siteblack py-8 sm:px-12 px-8 flex-col">
      ...
      <div className="flex-1 flex justify-center flex-col xl:mt-0 my-16">
        <div className="flex flex-row w-full">
          ...
          <h1 className="font-rajdhani font-bold text-white sm:text-6xl text-4xl text-left">Welcome to the <br /> AVAXQuest Web3.0 Game</h1>
        </div>
        ...
        <div className="flex flex-col">
          ...
          <button type="button" className="mt-6 px-4 py-2 rounded-lg bg-siteViolet w-fit text-white font-rajdhani font-bold">Connect</button>
        </div>
      </div>
